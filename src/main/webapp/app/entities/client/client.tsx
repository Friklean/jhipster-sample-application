  ...
  return (
    <div>
      <h2 id="client-heading" data-cy="ClientHeading">
        <Translate contentKey="jhtestApp.client.home.title">Clients</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jhtestApp.client.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/client/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jhtestApp.client.home.createLabel">Create new Client</Translate>
          </Link>
        </div>
      </h2>
        ...
        {clientList && clientList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="jhtestApp.client.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('nom')}>
                  <Translate contentKey="jhtestApp.client.nom">Nom</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('nom')} />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jhtestApp.client.home.notFound">No Clients found</Translate>
            </div>
          )
        )}
      </div>
