...
import fr.it_akademy.jhtest.service.mapper.CommandeMapper;
...
class CommandeResourceIT {
    ...
    private static final String DEFAULT_LISTE_ARTICLE = "AAAAAAAAAA";
    private static final String UPDATED_LISTE_ARTICLE = "BBBBBBBBBB";

    private static final String DEFAULT_HEURE_DE_COMMANDE = "AAAAAAAAAA";
    private static final String UPDATED_HEURE_DE_COMMANDE = "BBBBBBBBBB";
    ...
    public static Commande createEntity(EntityManager em) {
        Commande commande = new Commande()
            .listeArticle(DEFAULT_LISTE_ARTICLE)
            .heureDeCommande(DEFAULT_HEURE_DE_COMMANDE)
    ...
    public static Commande createUpdatedEntity(EntityManager em) {
        Commande commande = new Commande()
            .listeArticle(UPDATED_LISTE_ARTICLE)
            .heureDeCommande(UPDATED_HEURE_DE_COMMANDE)
    ...
    void createCommande() throws Exception {
        ...
        assertThat(testCommande.getListeArticle()).isEqualTo(DEFAULT_LISTE_ARTICLE);
        assertThat(testCommande.getHeureDeCommande()).isEqualTo(DEFAULT_HEURE_DE_COMMANDE);
    ...
    void getAllCommandes() throws Exception {
        ...
        restCommandeMockMvc
            ...
            .andExpect(jsonPath("$.[*].listeArticle").value(hasItem(DEFAULT_LISTE_ARTICLE)))
            .andExpect(jsonPath("$.[*].heureDeCommande").value(hasItem(DEFAULT_HEURE_DE_COMMANDE)))
    ...
    void getCommande() throws Exception {
        ...
        restCommandeMockMvc
            ...
            .andExpect(jsonPath("$.listeArticle").value(DEFAULT_LISTE_ARTICLE))
            .andExpect(jsonPath("$.heureDeCommande").value(DEFAULT_HEURE_DE_COMMANDE))
    ...
    void putExistingCommande() throws Exception {
        ...
        updatedCommande.listeArticle(UPDATED_LISTE_ARTICLE).heureDeCommande(UPDATED_HEURE_DE_COMMANDE).paiement(UPDATED_PAIEMENT);
        ...
        Commande testCommande = commandeList.get(commandeList.size() - 1);
        assertThat(testCommande.getListeArticle()).isEqualTo(UPDATED_LISTE_ARTICLE);
        assertThat(testCommande.getHeureDeCommande()).isEqualTo(UPDATED_HEURE_DE_COMMANDE);
    ...
    void fullUpdateCommandeWithPatch() throws Exception {
        ...
        partialUpdatedCommande.listeArticle(UPDATED_LISTE_ARTICLE).heureDeCommande(UPDATED_HEURE_DE_COMMANDE).paiement(UPDATED_PAIEMENT);
